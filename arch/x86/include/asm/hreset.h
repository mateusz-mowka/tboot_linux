 ...
 *
 * Request the processor to reset selected components of hardware history
 * maintained by the current logical processor. The history components to be
 * reset are specified in %eax. Only bits specified in CPUID(0x20).EBX
 * and specified in the IA32_HRESET_ENABLE MSR can be selected.
 *
