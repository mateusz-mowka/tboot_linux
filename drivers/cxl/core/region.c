...
/* Calculate a CXL Endpoint Decoder position in a region interleave */
			       ...
			       int region_ways)
{
	...
	if (parent_ways == region_ways) {
		dev_dbg(&cxlmd->dev, "ALISONPB QUICK way out\n");
		goto out;
	}
			     ...
			     struct cxl_endpoint_decoder *cxled, int pos)
{
	...
	/*
	 * Run this successfully setup user defined region through
	 * the calculator intended for autodiscovered regions. This
	 * is a test of the autodiscovery calculator and has no
