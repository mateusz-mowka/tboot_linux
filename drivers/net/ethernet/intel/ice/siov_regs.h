...
/* 2k Rx queues begin at offset after 1MB (after 256 4k pages) */
#define VDEV_QRX_TAIL_START		0x100000
#define VDEV_QRX_TAIL(_i)		(VDEV_QRX_TAIL_START + \
					 ((_i) * 0x1000))

/* 2k Rx buffer queues begin at offset of 9MB */
#define VDEV_QRX_BUFQ_TAIL_START	0x900000
#define VDEV_QRX_BUFQ_TAIL(_i)		(VDEV_QRX_BUFQ_TAIL_START + \
					 ((_i) * 0x1000))

/* 2k Tx queues begin at offset of 17MB */
#define VDEV_QTX_TAIL_START		0x1100000
#define VDEV_QTX_TAIL(_i)		(VDEV_QTX_TAIL_START + \
					 ((_i) * 0x1000))

/* 2k Tx completion queues begin at offset of 25MB */
#define VDEV_QTX_COMPL_TAIL_START	0x1900000
#define VDEV_QTX_COMPL_TAIL(_i)		(VDEV_QTX_COMPL_TAIL_START + \
					 ((_i) * 0x1000))

/* Interrupt control begins offset 33MB */
#define VDEV_INT_DYN_CTL01		0x2100000

/* CTL01 register begins at offset of 33MB + 4k */
#define VDEV_INT_DYN_START		(VDEV_INT_DYN_CTL01 + 0x1000)
#define VDEV_INT_DYN_CTL(_i)		(VDEV_INT_DYN_START + ((_i) * 0x1000))
#define VDEV_INT_ITR_0(_i)		(VDEV_INT_DYN_START + \
					 ((_i) * 0x1000) + 0x04)
#define VDEV_INT_ITR_1(_i)		(VDEV_INT_DYN_START + \
					 ((_i) * 0x1000) + 0x08)
#define VDEV_INT_ITR_2(_i)		(VDEV_INT_DYN_START + \
					 ((_i) * 0x1000) + 0x0C)
