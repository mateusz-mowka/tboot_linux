...
static const struct intel_community mtps_community0[] = {
	MTP_COMMUNITY(0, 82, mtps_community0_gpps),
};
...
static const struct pinctrl_pin_desc mtps_community3_pins[] = {
	...
	PINCTRL_PIN(38, "USB2_OCB_0"),
	PINCTRL_PIN(39, "USB2_OCB_1"),
	PINCTRL_PIN(40, "USB2_OCB_2"),
	PINCTRL_PIN(41, "USB2_OCB_3"),
	...
	/* vGPIO_3 */
	PINCTRL_PIN(53, "CPU_PCIE_LNK_DN_0"),
	PINCTRL_PIN(54, "CPU_PCIE_LNK_DN_1"),
	PINCTRL_PIN(55, "CPU_PCIE_LNK_DN_2"),
	PINCTRL_PIN(56, "CPU_PCIE_LNK_DN_3"),
	/* vGPIO_0 */
	PINCTRL_PIN(57, "ESPI_USB_OCB_0"),
	PINCTRL_PIN(58, "ESPI_USB_OCB_1"),
	PINCTRL_PIN(59, "ESPI_USB_OCB_2"),
	PINCTRL_PIN(60, "ESPI_USB_OCB_3"),
	PINCTRL_PIN(61, "USB_CPU_OCB_0"),
	PINCTRL_PIN(62, "USB_CPU_OCB_1"),
	PINCTRL_PIN(63, "USB_CPU_OCB_2"),
	PINCTRL_PIN(64, "USB_CPU_OCB_3"),
	PINCTRL_PIN(65, "USB_CPU_OCB_4"),
	PINCTRL_PIN(66, "USB_CPU_OCB_5"),
	PINCTRL_PIN(67, "USB_CPU_OCB_6"),
	PINCTRL_PIN(68, "USB_CPU_OCB_7"),
};
...
static const struct intel_padgroup mtps_community3_gpps[] = {
	...
	MTP_GPP(3, 53, 56),	/* vGPIO_3 */
	MTP_GPP(4, 57, 68),	/* vGPIO_0 */
};

static const struct intel_community mtps_community3[] = {
	MTP_COMMUNITY(0, 68, mtps_community3_gpps),
};
...
static const struct pinctrl_pin_desc mtps_community4_pins[] = {
	...
	PINCTRL_PIN(17, "SRCCLKREQB_12"),
	PINCTRL_PIN(18, "SRCCLKREQB_13"),
	PINCTRL_PIN(19, "GPP_E_11"),
	PINCTRL_PIN(20, "GPP_E_12"),
